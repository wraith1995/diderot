...
structure EinFilter : sig
  ...
  (************** Functions that partition expressions **************)
    ...
    fun partitionGreek exps = let
		  ...
		  | E.Probe(E.Fem(_,_,_,_,[],[]), _) => part (es, e::pre, eps, dels, post)
