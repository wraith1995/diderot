...
structure AST =
  ...
  (* global declarations *)
    ...
    and expr
      ...
      | E_FemField of expr * expr option * Ty.ty * FemOpt.femField * var_use option (* Given a possible data source, a possible cell source, a field type, an opt, and a possible function, we get a fem specific field. *)
