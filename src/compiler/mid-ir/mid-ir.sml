...
structure MidOps =
  ...
  (* required helper functions for the index control type type *)
    ...
    fun hash IAdd = 0w3
      ...
      | hash (Transform(a0)) = 0w211 + ImageInfo.hash a0
      | hash (Translate(a0)) = 0w223 + ImageInfo.hash a0
      | hash (LoadVoxels(a0,a1)) = 0w227 + ImageInfo.hash a0 + hashint a1
      | hash (LoadVoxelsWithCtl(a0,a1,a2)) = 0w229 + ImageInfo.hash a0 + hashint a1 + hashidxctl a2
      | hash (Inside(a0,a1)) = 0w233 + ImageInfo.hash a0 + hashint a1
      | hash (IndexInside(a0,a1)) = 0w239 + ImageInfo.hash a0 + hashint a1
      | hash (ImageDim(a0,a1)) = 0w241 + ImageInfo.hash a0 + hashint a1
      | hash (BorderCtlDefault(a0)) = 0w251 + ImageInfo.hash a0
      | hash (BorderCtlClamp(a0)) = 0w257 + ImageInfo.hash a0
      | hash (BorderCtlMirror(a0)) = 0w263 + ImageInfo.hash a0
      | hash (BorderCtlWrap(a0)) = 0w269 + ImageInfo.hash a0
      | hash (LoadSeq(a0,a1)) = 0w271 + hashty a0 + hashstring a1
      | hash (LoadImage(a0,a1)) = 0w277 + hashty a0 + hashstring a1
      | hash (LoadFem(a0)) = 0w281 + hashty a0
      | hash (ExtractFemItem(a0,a1)) = 0w283 + hashty a0 + FemOpt.hash a1
      | hash (ExtractFemItem2(a0,a1,a2)) = 0w293 + hashty a0 + hashty a1 + FemOpt.hash a2
      | hash (ExtractFem(a0,a1)) = 0w307 + hashty a0 + hashty a1
      | hash KillAll = 0w311
      | hash StabilizeAll = 0w313
      | hash (Print(a0)) = 0w317 + hashtys a0
      | hash (MathFn(a0)) = 0w331 + MathFns.hash a0
