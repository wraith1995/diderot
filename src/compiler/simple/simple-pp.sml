...
structure SimplePP : sig
    ...
    val output : TextIO.outstream * string * Simple.program * (SimpleVar.t -> string ) -> unit

    val outputFunc : TextIO.outstream * string * Simple.func_def * SimpleVar.t -> string  -> unit
   ...
   *)
    ...
    fun ppVar (ppStrm, x, f) = PP.string ppStrm (V.uniqueNameOf x)
    ...
    fun output (outS, message, prog, vPropP, f) = let
          val S.Program{
