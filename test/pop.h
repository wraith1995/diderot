...
/*! \file pop.h
 *
 * C interface to library generated from test/pop.diderot.
 *
 * Command: bin/diderotc --log --dump-ast test/pop.diderot
...
bool Diderot_output_get_r (Diderot_world_t *wrld, Nrrd *data);
/*---------- begin lib-h-foot.in ----------*/
