...
meshDatas = buildFiredrakeTetMesh("meshfiles/main.msh", 3, linearGmshBackup="lin_meshfiles/lin_gcs2.msh")
linMesh = meshDatas[-1]
...
#[0.8, 0.1, 0.5],
numPoints = 5000
newXc = np.random.uniform(low=-1.45, high=1.45, size=numPoints)
newYc = np.random.uniform(low=-1.45, high=1.45, size=numPoints)
newZc = np.random.uniform(low=-1.45, high=1.45, size=numPoints)
# if dim == 3:
