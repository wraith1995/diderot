...
/*! \file fun.h
 *
 * C interface to library generated from fun.diderot.
 *
...
bool Diderot_input_set_by_name_A (Diderot_world_t *wrld, const char *s);
bool Diderot_input_set_A (Diderot_world_t *wrld, Nrrd *data);
/*---------- begin lib-h-body.in ----------*/
...
bool Diderot_output_get_result (Diderot_world_t *wrld, Nrrd *data);
/*---------- begin lib-h-foot.in ----------*/
