...
/*! \file crap.h
 *
 * C interface to library generated from crap.diderot.
 *
 * Command: ../bin/diderotc --log --dump-pt --dump-ast --dump-simple --dump-high --dump-mid --dump-low --dump-tree crap.diderot
